    ...
    <>
      <div className="services-section">
        <div className="services-section-container">
          ...
          <div className="services-list-container">
            <div className="services-subheading">Resource Augumentation</div>
      ...
      <div className="services-section">
        <div className="services-section-container">
          ...
          <div className="services-list-container">
            <div className="services-subheading">Supply Chain Management</div> 
            {renderSlider(servicesList.applicationDevelopment, 'applicationDevelopment')}
          </div>
          <div className="services-list-container">
            <div className="services-subheading">Resource Planning</div>
      ...
      <div className="services-section">
        <div className="services-section-container">
          ...
          <div className="services-list-container">
            <div className="services-subheading">Application Development</div>
            {renderSlider(servicesList.applicationDevelopment, 'applicationDevelopment')}
          </div>
          <div className="services-list-container">
            <div className="services-subheading">Google Cloud Services</div>
            {renderSlider(servicesList.googleCloudServices, 'googleCloudServices')}
          </div>
          <div className="services-list-container">
            <div className="services-subheading">Amazon Web Services</div>
            {renderSlider(servicesList.amazonWebServices, 'amazonWebServices')}
          </div>
          <div className="services-list-container">
            <div className="services-subheading">Microsoft Azure</div>
      ...
      <div className="services-section">
        <div className="services-section-container">
          ...
          <div className="services-list-container">
            <div className="services-subheading">Data Driven Solutions</div>
            {renderSlider(servicesList.dataDrivenSolutions, 'dataDrivenSolutions')}
          </div>
          <div className="services-list-container">
            <div className="services-subheading">Image Processing</div>
      ...
      <div className="services-section">
        <div className="services-section-container">
          ...
          <div className="services-list-container">
            <div className="services-subheading">Project Planning and Scoping</div>
            {renderSlider(servicesList.projectPlanning, 'projectPlanning')}
          </div>
          <div className="services-list-container">
            <div className="services-subheading">Agile Development</div>
